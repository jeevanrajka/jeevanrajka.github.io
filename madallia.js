...
(function(){
	...
	t.async=true;
	t.src=KAMPYLE_EMBED.getGenericLocation();document.body.appendChild(t);},kampyleLoadLogger:function(){},kampyleEventHandler:function(elem,eventType,handler){if(elem.addEventListener){elem.addEventListener(eventType,handler,false);}
...
return false;},getGenericLocation:function(){var cloudLocation='http:'+'//'+'nebula-cdn.kampyle.com/we/56138/onsite/generic1512643574733.js';var genericPath=(cloudLocation.match(/\/[a-zA-Z\d-]+\/\d+\/onsite\/generic\d{13}\.js$/)||[])[0];return window.KAMPYLE_EMBED.isOnPrem()?window.KAMPYLE_EMBED.getResourcesPrefix()+genericPath:cloudLocation;},getResourcesPrefix:function(){if(window.MDIGITAL_ON_PREM_PREFIX){return window.MDIGITAL_ON_PREM_PREFIX;}
